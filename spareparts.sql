...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-01-2025 a las 18:24:00
...
ALTER TABLE `detalle_factura`
  ...
  ADD CONSTRAINT `detalle_factura_ibfk_2` FOREIGN KEY (`id_pieza`) REFERENCES `piezas` (`id_pieza`);
